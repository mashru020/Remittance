...
$( document ).ready(function() {
	...
	$(document).on('click', 'button.navbar-toggler', function() {
  	...
  	$( "#send-input" ).spinner();
  	// $('#s-currency').selectpicker();
  	// $('#g-currency').selectpicker();  	
  	// $('#transfer-type').selectmenu();
  	$('#transfer-type').selectpicker();
  	$('#s-currency').select2();
  	$('#s-currency').on('select2:closing', function(){
  		$('.select2-search--dropdown').removeClass('focus');
  	});
  	$('#g-currency').select2();
  	$('#g-currency').on('select2:closing', function(){
  		$('.select2-search--dropdown').removeClass('focus');
  	});
